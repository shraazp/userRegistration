...
import java.util.*;
public class UserResgistrationLambda {
    ...
    public static void main(String[] args) 
    {
        ...
        Predicate<String> firstnameFilter = Pattern
                .compile("^[A-Z][A-Za-z0-9]{2,}")
                .asPredicate(); 
        System.out.println(firstnameFilter.test(fname)); 
        //validate last name
        System.out.println("Last name:");
        String lname=sc.nextLine();
        Predicate<String> lastnameFilter = Pattern
               .compile("^[A-Z][A-Za-z0-9]{2,}")
               .asPredicate(); 
        ...
        Predicate<String> mobileFilter = Pattern
             .compile("91 [1-9][0-9]{9}")
             .asPredicate(); 
        System.out.println(mobileFilter.test(mobile));
        //validate password
        System.out.println("Password:");
        String password=sc.nextLine();
        Predicate<String> passwordFilter = Pattern
